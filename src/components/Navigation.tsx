                ...
                {isMenuOpen && (
                    ...
                    >
                        <motion.div 
                            ...
                            className="bg-white w-full max-w-5xl rounded-2xl md:rounded-3xl p-6 md:p-12 shadow-2xl overflow-hidden relative"
                        >
                            {/* Modal Header */}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 mb-16 md:mb-24">
                                ...
                                <div className="flex flex-col space-y-6 md:space-y-8">
                                    <a href="#about" onClick={() => setIsMenuOpen(false)} className="text-2xl md:text-4xl hover:text-brand-dark text-brand-dark/80 transition-colors font-medium tracking-tight">
                                        Our Story
                                    </a>
                                    <a href="#menu" onClick={() => setIsMenuOpen(false)} className="text-2xl md:text-4xl hover:text-brand-dark text-brand-dark/80 transition-colors font-medium tracking-tight">
                                        Menu
                                    </a>
                                    <a href="#booking" onClick={() => setIsMenuOpen(false)} className="text-2xl md:text-4xl hover:text-brand-dark text-brand-dark/80 transition-colors font-medium tracking-tight">
                                        Reservations
                                    </a>
                                    <a href="https://wa.me/250783343290" target="_blank" rel="noopener noreferrer" onClick={() => setIsMenuOpen(false)} className="text-2xl md:text-4xl hover:text-brand-dark text-brand-dark/80 transition-colors font-medium tracking-tight">
                                        Order Online
                                    </a>
                                </div>
                            ...
                            {/* Modal Footer */}
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center pt-8 border-t border-brand-dark/10 gap-4 md:gap-0">
